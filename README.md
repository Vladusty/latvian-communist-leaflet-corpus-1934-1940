...
**At this stage, the corpus includes all leaflets from 1934–1935 that were published in this volume.**
...
* **`latvian_communist_leaflets_1934-1940/`**  
  ...
  - Currently includes **174 unique leaflet texts** (with more to be added).  
